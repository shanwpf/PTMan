...
public class DecryptDataCommand extends Command {
    ...
    public static final String MESSAGE_ENCRYPT_SUCCESS = "Local files successfully decrypted.";
    public static final String MESSAGE_ENCRYPT_FAILURE = "Local files have already been decrypted.";
