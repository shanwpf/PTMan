...
public class EditCommandTest {
    ...
    public void execute_duplicatePersonFilteredList_failure() {
        ...
        Person personInList = model.getPartTimeManager().getPersonList().get(INDEX_SECOND_PERSON.getZeroBased());
        EditCommand editCommand = prepareCommand(INDEX_FIRST_PERSON,
    ...
    public void execute_invalidPersonIndexFilteredList_failure() {
        ...
        assertTrue(outOfBoundIndex.getZeroBased() < model.getPartTimeManager().getPersonList().size());
    ...
    public void executeUndoRedo_validIndexUnfilteredList_success() throws Exception {
        ...
        // undo -> reverts parttimemanager back to previous state and filtered person list to show all persons
