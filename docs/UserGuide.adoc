...
** **`add`**`n/John Doe p/98765432 e/johnd@example.com a/John street, block 123, #01-01` : Adds an employee named `John Doe` to PTMan.
...
Adds an employee named `John Doe` with phone number `98765432` and address `John street, block 123, #01-01`.
* `add n/Betsy Crowe e/betsycrowe@example.com a/Newgate Prison p/1234567` +
Adds an employee named `Betsy Crowe` with email `betsycrowe@example.com`, address `Newgate Prison`, and phone number `1234567`.
