...
Exports the current timetable displayed as an image and either saves it locally, or emails the exported timetable to the input email address. +
...
_Figure 5._ Example of `editoutlet` command usage +
...
_Figure 6._ Successful editing of outlet information in PTMan +
...
_Figure 7._ Example of `announce` command usage +
...
_Figure 8._ Successful announcement made in PTMan +
