...
.. *Password*: Added password to every single employee and outlet.
.. *Password governed commands*: All employer commands need to have admin password to work. Employee's passwords is needed if he/she wants to allocate to a working slot.
.. *Change password command*: Employee and employer are able to change password to keep their data/password a secret.
...
1.  Employer enters employee details and working outlet(s)
2.  PTMan adds the employee
+
Use case ends.
...
1.  Employer enters an employee's name and working outlet.
2.  PTMan finds the employee in the corresponding outlet.
3.  Employer enters new details of the employee that he wants to update.
4.  PTMan changes the employee's details.
+
Use case ends.
...
+
Use case resumes at step 1.
* 1b. The employee cannot be found.
+
[none]
** 1b1. PTMan shows an error message.
+
Use case resumes at step 1.
* 3a. The entered format of new details is invalid.
+
[none]
** 3a1. PTMan shows an error message.
+
...
[discrete]
=== Use case: Sign up for available time slots

*MSS*

1.  Employee enters a time slot that he wants to sign up and the corresponding outlet.
2.  PTMan sends a confirm message.
3.  Employee confirms.
4.  PTMan updates the indicated time slot in the timetable of the indicated outlet.
+
Use case ends.
...
+
Use case resumes at step 1.
* 1b. The time slot is not available.
+
[none]
** 1b1. PTMan shows an error message.
+
Use case resumes at step 1.
* 1c. The outlet is invalid.
+
[none]
** 1c1. PTMan shows an error message.
+
Use case resumes at step 1.
* 3a. The employee does not confirm.
+
[none]
** 3a1. PTMan shows a message that employee cancels the request.
+
Use case ends.

[none]
* 1b. The entered outlet already exist.
+
[none]
** 1b1. PTMan shows an error message.
+
...
1.  Employer enters outlet details
2.  PTMan adds the outlet into the list of outlet
+
Use case ends.
...
.  Should be usable by users who has never used a command line interface before.
.  Should be expected to manage contact details of part-time workers in any outlet.
.  Should be expected to manage work schedule in any outlet.
