...
In order to create a shift, the date, starting time, ending time, and capacity of the shift must be specified.
Figure 11 is a class diagram that displays the association between `Shift` and other components in the `Model`.
