...
As of version 1.2, each person and outlet now has a class password. Refer to the diagram below:
...
----
The sequence Diagram below illustrate how the admin command is generally executed.
