...
.. _Unit tests_ that test the individual components. These are in `seedu.ptman.ui` package.
...
|`* * *` |user |have an authentication page |prevent unauthorized access to my information.

|`* * *` |user |update my password |keep my account secure.
...
|`* * *` |employee |select from the available slots |work during that slot.

|`* * *` |employer |add outlet |update the app with new outlets

|`* *` |employer |sort employees by name |have a clearer view of all employees’ details.

|`* *` |employer |add a new admin account |have multiple managers.

|`* *` |employer |find an employee by name |locate details of employees without having to go through the entire list.

|`* *` |employer |find employees by outlet |locate details of employees according to the outlet they are working at.

|`* *` |employer |view an employee’s working outlet |view their working outlet.

|`* *` |employer |edit an employee’s working outlet |edit their working outlet.
...
|`*` |employee |have notification for the selected slot |be assured that I am working at that slot.
|=======================================================================
